...
const translations = {
    el: {
        ...
        "portfolio-item2-desc": "Πλατφόρμα online κρατήσεων για εστιατόρια, με διαχείριση τραπεζιών σε πραγματικό χρόνο.",
        "portfolio-item3-tag": "Οικονομική Διαχείριση",
        "portfolio-item3-desc": "Offline-first εφαρμογή διαχείρισης οικονομικών, με εφάπαξ άδεια χρήσης.",
        "portfolio-item4-tag": "Εστιατόριο & Κρατήσεις",
        "portfolio-item4-desc": "Ιστοσελίδα & σύστημα online κρατήσεων για ιστορικό εστιατόριο στην Πλάκα.",
        "portfolio-item5-tag": "Πολιτισμός & ΑΜΚΕ",
        "portfolio-item5-title": "ΑΜΚΕ Διεθνής Δράση",
    ...
    en: {
        ...
        "portfolio-item2-desc": "Online reservation platform for restaurants, with real-time table management.",
        "portfolio-item3-tag": "Finance Management",
        "portfolio-item3-desc": "Offline-first finance management app, with a one-time license.",
        "portfolio-item4-tag": "Restaurant & Reservations",
        "portfolio-item4-desc": "Website & online reservation system for a historic restaurant in Plaka.",
        "portfolio-item5-tag": "Culture & NGO",
        "portfolio-item5-title": "Diethnis Drasi NPO",
